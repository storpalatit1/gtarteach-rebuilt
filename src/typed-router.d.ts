...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/notes/chordFormula': RouteRecordInfo<'/notes/chordFormula', '/notes/chordFormula', Record<never, never>, Record<never, never>>,
    '/notes/chordNameToFormula': RouteRecordInfo<'/notes/chordNameToFormula', '/notes/chordNameToFormula', Record<never, never>, Record<never, never>>,
